...
interface IERC1753 is IERC721 {
     ...
     */
    function issue(address account, uint256 validFrom, unit256 validTo) external returns (uint256);
    
	function hasValid(address account) external view returns (bool);
